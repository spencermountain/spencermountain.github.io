...
module.exports=[
  [
    { "classes": [""] },
    { "classes": [""] },
    { "classes": ["col2", ""], "image": "./assets/misc/church.jpg" },
    { "classes": ["bgpink"] },
    { "classes": [""] },
    { "classes": ["bgrose"] },
    { "classes": ["bgsky"] },
    { "classes": [""], "image": "./assets/misc/victoria-cow.jpg" }
  ],
  ...
  [
    ...
    { "classes": [""] },
    { "classes": [""] },
    { "classes": [""], "image": "./assets/misc/venus.jpg" },
    { "classes": [""] },
    { "classes": ["row2", "bgsky"] },
    { "classes": [""] },
    { "classes": ["f2", "right", "brown"], "text": "i'm worried" }
  ],
  ...
  [
    ...
    { "classes": ["bgpink"] },
    { "classes": [""] },
    { "classes": ["bggrey"], "image": "./assets/misc/satellite.jpg" },
    { "classes": [""] },
    { "classes": ["row2", ""] }
  ],
  ...
  [
    { "classes": [""] },
    { "classes": ["col2", "bgrose"], "image": "./assets/misc/saddam.jpg" },
    { "classes": ["bgpink"] },
    { "classes": ["row2", "bgblue"] },
    { "classes": ["bgbrown"], "image": "./assets/misc/mushrooms.jpg" },
    { "classes": [""] },
    { "classes": ["bgred"] },
    { "classes": ["bgsky"], "image": "./assets/misc/house.jpg" }
  ],
  ...
  [
    ...
    { "classes": ["col2", ""] },
    {
      "classes": ["row2", "f2", "m1", "sea", "maxw6"],
      "text": "computers do not work very well"
    },
    { "classes": ["h6"], "image": "./assets/misc/flood.jpg" },
    { "classes": [""] },
    { "classes": ["bgred"] },
    {
      "classes": []
  ...
  [
    { "classes": [""] },
    { "classes": [""], "image": "./assets/misc/europa.jpg" },
    {
      "classes": ["row2", "col2", "bggrey"],
      "image": "./assets/misc/cement-house.jpg"
    },
    { "classes": [""] },
    { "classes": [""], "image": "./assets/misc/hay.jpg" },
    { "classes": ["bgrose"] },
    { "classes": ["bggrey"] },
    { "classes": ["bgbrown"] }
  ],
  ...
  [
    ...
    { "classes": ["bgbrown"] },
    {
      "classes": ["f3", "dimgrey", "m1"],
      "text": "things are a mess."
    },
    { "classes": ["col2", "bgrose"] },
    { "classes": [""] },
    { "classes": ["row2", "bgsky"] },
    { "classes": ["bgsky"], "image": "./assets/misc/grandfather.jpg" },
    { "classes": ["bgbrown"] }
  ]
]
...
function _templateObject2() {
  var data = _taggedTemplateLiteral(["<div class=\"goldGrid mv6\">\n ", "\n</div>\n"]);
...
var h = htm.bind(_dereq_('vhtml')); // const generate = require('./generate')

var interesting = _dereq_('../interesting');

var shrinkGrid = _dereq_('./shrink-grid');

_dereq_('intersection-observer');

var scrollama = _dereq_('scrollama'); // instantiate the scrollama
...
scroller.setup({
  step: '.step'
}).onStepEnter(function (response) {// console.log(response)
  // { element, index, direction }
}).onStepExit(function (response) {// { element, index, direction }
}); // setup resize event

window.addEventListener('resize', scroller.resize); // let cells = generate()
// console.log(JSON.stringify(cells))

var drawGrid = function drawGrid(cells) {
  cells = cells.map(function (cell) {
    var classes = cell.classes.join(' ');
    var style = '';

    if (cell.image) {
      style += "background-image:url(".concat(cell.image, ");");
    }

    return h(_templateObject(), classes, style, cell.text);
  });
  return cells;
};

document.querySelector('#topGrid').innerHTML = shrinkGrid();
var grid = document.querySelector('#showAll');
var html = interesting.map(function (cells, i) {
  return h(_templateObject2(), drawGrid(cells));
}).join(' ');
grid.innerHTML = html;

},{"../interesting":1,"./shrink-grid":7,"htm":2,"intersection-observer":3,"scrollama":4,"vhtml":5}],7:[function(_dereq_,module,exports){
"use strict";

function _templateObject() {
  var data = _taggedTemplateLiteral(["<div id=\"grid\" class=\"row\">\n    <div\n      class=\"h8 grow maxw10 rounded clip\"\n      style=\"\ndisplay:grid;\ngrid-template-columns: 0.618fr 1fr 0.618fr 1fr ;\ngrid-template-rows: 1fr 0.618fr 1fr;\n\"\n    >\n      <div class=\" rounded\" />\n      <div\n        class=\" row2 hasImg\"\n        style='background-image: url(\"./assets/misc/boats.jpg\");'\n      />\n      <div class=\" bgpink\" />\n      <div class=\" \" />\n      <div\n        class=\" col2 hasImg\"\n        style='background-image: url(\"./assets/misc/sea.jpg\");'\n      />\n      <div class=\" bgsky\" />\n      <div class=\" \" />\n      <div class=\" bgpink\" />\n      <div\n        class=\" bgpink hasImg\"\n        style='background-image: url(\"./assets/misc/orange.jpg\");'\n      />\n      <div class=\" bgrose\" />\n    </div>\n  </div>"]);

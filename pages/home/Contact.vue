...
<template>
  <section>
    <Stage class="my-30">
      <hr class="mx-auto w-[70%] border-lighter" />
    </Stage>
    <!-- contact -->
    <Stage class="my-46">
      <div class="text-center text-4xl">
        <a href="mailto:spencermountain@gmail.com">email</a> me <br />
        <div class="mt-9 text-2xl">if you want</div>
        <div class="mt-9 text-base">i don't work hard.</div>
      </div>
    </Stage>
    <!-- links -->
    <div class="row mb-14">
